...
let choixDeDif = prompt("FACILE, NORMAL OU DIFFICLE ?");
...
// DECLARATION DE LA VARIABLE POUR LE CHANGEMENT D'IMAGE EN FONCTION DES POINTS DE VIE GENERES
...
while (pvJoueur > 0 && pvDragon > 0) {
    ...
    if (compareInit() == 1) {
        ...
        // ON SOUSTRAIT LE NOMBRE DE DEGATS AU POINT DE VIE ACTUEL
        pvJoueur = pvJoueur - degAttDragon;

        // L'IMAGE QUI CHANGE EN FONCTION DU POURCENTAGE DE VIE
...
// ON AFFICHE LE RESULTAT UNE FOIS LA BOUCLE FINIS DANS LE FOOTER
